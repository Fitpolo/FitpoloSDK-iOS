...
@implementation mk_fitpoloLogManager
...
+ (void)writeCommandToLocalFile:(NSArray *)dataList sourceInfo:(mk_logDataDirection )source{
    ...
    NSString *sourceInfo = (source == mk_logDataSourceAPP ? @"app:" : @"device:");
